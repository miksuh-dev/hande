    ...
    >
      <div class="relative flex w-full flex-row">
        <div>
          ...
          <button
            class="z-10 inline-flex h-full w-28 flex-shrink-0 items-center justify-between rounded-l-lg border border-neutral-300 bg-white py-2.5 px-4 text-center text-sm font-medium text-neutral-900 hover:bg-neutral-100 focus:outline-none dark:border-neutral-600 dark:bg-neutral-700 dark:text-white dark:hover:bg-neutral-600"
            type="button"
            onClick={(e) => {
              e.stopPropagation();
        ...
        <div class="relative flex-1">
          ...
          <input
            type="text"
            class="secondary rounded-l-none border-l-0 p-2.5 pl-10"
