...
import { Song, PlayingSong, PlayingTypeSong } from "trpc/types";
          ...
          >
            <div class="flex flex-1 flex-row items-center justify-between space-y-2">
              <div class="flex h-full flex-row space-x-8">
                ...
                >
                  <YoutubeEmbedding song={song as Accessor<PlayingTypeSong>} />
                </Show>
            ...
            <div class="flex flex-row space-x-2">
              ...
              <Show when={song().type === "song"}>
                <Progress playing={song as Accessor<PlayingTypeSong>} />
              </Show>
            </div>
          </div>
        )}
